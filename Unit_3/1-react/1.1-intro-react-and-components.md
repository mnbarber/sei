...
The Vite team has developed a wonderful script for generating React apps.
...
Although using<br>`npx create-react-app create vite@latest`<br>is a great way to start an actual React project, we can save our disk space when learning and experimenting by using the most excellent code playground, [CodeSandbox](https://codesandbox.io/)...
