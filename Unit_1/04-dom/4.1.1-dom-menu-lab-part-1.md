...
- In your code folder make a folder called `dom-menu-lab`
- change into the directory and make your normal file structure
...
- linking the css looks like this in the head 
