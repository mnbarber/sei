...
create basic file structure inside a folder called js-arrays in your code folder!
...
Copy the exercises below into your  **app.js** file and code away!

This lab is **a DELIVERABLE** - Submit the deliverable in the slack thread (we'll show you how to do this tomorrow)
